...
prompt Spooling to file ddl_staymetadata_on_spool.txt

prompt

SET termout OFF
spool ddl_staymetadata_on_spool.txt
...
update "&gg_user"."&setup_table" set value='ON' where property='DDL_STAYMETADATA';
commit;
