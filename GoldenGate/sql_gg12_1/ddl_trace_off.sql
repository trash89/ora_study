...
--
-- Program description:
-- Turn OFF Trace DDL execution for use with TKPROF
...
prompt Spooling to file ddl_trace_off_spool.txt

prompt

SET termout OFF
spool ddl_trace_off_spool.txt
...
update "&gg_user"."&setup_table" set value=0 where property='DDL_SQL_TRACING';
commit;
...
prompt
prompt NOTE: You must exit current session for tracing to stop.
